    ...
    namespace hardwarecommunication
    {
        ...
        class InterruptManager
        {
            ...
            protected:
                ...
                static void HandleInterruptRequest0x80();   // Handles software interrupts
            ...
            public:
                ProcessTable* tableManager;

                InterruptManager(myos::common::uint16_t hardwareInterruptOffset, myos::GlobalDescriptorTable* globalDescriptorTable, ProcessTable* tableManager);
                ~InterruptManager();
                myos::common::uint16_t HardwareInterruptOffset();
                void Activate();
                void Deactivate();
