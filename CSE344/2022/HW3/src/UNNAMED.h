...
#define SHMFILENAME "shmfile_for_unnamed_part"
...
struct SHMCONTENT
{
	...
	sem_t milk, flour, walnuts, sugar;
	sem_t milkAndFlour, milkAndWalnuts, milkAndSugar;
	sem_t flourAndWalnuts, flourAndSugar, walnutsAndSugar;
