...
public class BranchEmployee extends Person implements CompanyBranchEmployee
{
    ...
    {
        return getBranch().getCompany().getCustomer().insert(new Person(name,surname,id));
    }
    ...
    {
        return getBranch().getCompany().getCustomer().erase(new Person(name,surname,id));
    }
    ...
    {
        return getBranch().getShipment().insert(new Shipment(trackingNumber,sender,receiver,Status.ATBRANCH));
    }
    ...
    {
        return getBranch().getShipment().erase(new Shipment(trackingNumber,null,null,null));
    }
