...
public class Administrator extends Person implements CompanyAdministrator
{
    ...
    public boolean addBranchEmployee(int branchCode, String name, String surname, int id)
    {
        ...
        return getCompany().getBranch().at(index).getBranchEmployee().insert(new BranchEmployee(getCompany().getBranch().at(index),name,surname,id));
    }
    ...
    public boolean removeBranchEmployee(int branchCode, String name, String surname, int id)
    {
        ...
        return getCompany().getBranch().at(index).getBranchEmployee().erase(new BranchEmployee(getCompany().getBranch().at(index),name,surname,id));
    }
    ...
    {
        return getCompany().getTransportationPersonnel().insert(new TransportationPersonnel(getCompany(),name,surname,id));
    }
    ...
    {
        return getCompany().getTransportationPersonnel().erase(new TransportationPersonnel(getCompany(),name,surname,id));
    }
