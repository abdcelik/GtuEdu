...
public class Branch
{
    ...
    private container<Shipment> shipment;
     ...
     */
    public container<BranchEmployee> getBranchEmployee() { return branchEmployee; }

    /**
     * Getter function for the branch's shipments.
     * @return the branch's shipments.
     */
    public container<Shipment> getShipment() { return shipment; }
