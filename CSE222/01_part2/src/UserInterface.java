...
public class UserInterface
{
        ...
        while(choice != -1)
        {
            ...
            switch(choice) {
                ...
                case 5:
                    ...
                    if((var = company.getBranch().indexOf(branch)) != -1)
                        printAllBranchEmployees(company.getBranch().get(var));
                    else
                ...
                case 6:
                    ...
                    if(company.getBranch().contains(branch))
                    {
    ...
    public static void printAllTransportationPersonnel(CargoCompany company)
    {
        for(int i=0 ; i < company.getTransportationPersonnel().size() ; ++i)
            System.out.println(company.getTransportationPersonnel().get(i));
    }
    ...
    public static void branchEmployeeMenu(CargoCompany company)
    {
        ...
        if((i = company.getBranch().indexOf(branch)) == -1)
        {
            System.out.println("Wrong branch code! Try again!");
            return;
        }

        if((j = company.getBranch().get(i).getBranchEmployee().indexOf(employee)) == -1)
        {
            System.out.println("Wrong name,surname or id! Try Again!");
            return;
        }
        ...
        employee = company.getBranch().get(i).getBranchEmployee().get(j);
        int choice=0;
    ...
    public static void transportationPersonnelMenu(CargoCompany company)
    {
        ...
        if((index = company.getTransportationPersonnel().indexOf(personnel)) == -1)
        {
            System.out.println("Wrong name,surname or id! Try Again!");
            return;
        }
